                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control mt-2 @error('intruksi') is-invalid @enderror" name="intruksi"
                                    ...
                                    <option value="Untuk diselesaikan lebih lanjut" @if (old('intruksi') == 'Untuk diselesaikan lebih lanjut') {{ 'selected' }} @endif>
                                        Untuk diselesaikan lebih lanjut
                                    </option>
                                    <option value="Untuk dilaksanakan penuh tanggung jawab" @if (old('intruksi') == 'Untuk dilaksanakan penuh tanggung jawab') {{ 'selected' }} @endif>
                                        Untuk dilaksanakan penuh tanggung jawab
                                    </option>
                                    <option value="Diusahakan untuk mengikuti" @if (old('intruksi') == 'Diusahakan untuk mengikuti') {{ 'selected' }} @endif>
                                        Diusahakan untuk mengikuti
                                    </option>
                                    <option value="Tugas sekolah diatur sebaik-baiknya dengan guru piket" @if (old('intruksi') == 'Tugas sekolah diatur sebaik-baiknya dengan guru piket') {{ 'selected' }} @endif>
                                        Tugas sekolah diatur sebaik-baiknya dengan guru piket
                                    </option>
                                    <option value="Untuk dikonfirmasikan dengan pihak terkait" @if (old('intruksi') == 'Untuk dikonfirmasikan dengan pihak terkait') {{ 'selected' }} @endif>
                                        Untuk dikonfirmasikan dengan pihak terkait
                                    </option>
                                    <option value="Diteruskan kepada yang bersangkutan" @if (old('intruksi') == 'Diteruskan kepada yang bersangkutan') {{ 'selected' }} @endif>
                                        Diteruskan kepada yang bersangkutan
                                    </option>
                                    <option value="Untuk dikopi dan dipasang di Papan Pengumuman" @if (old('intruksi') == 'Untuk dikopi dan dipasang di Papan Pengumuman') {{ 'selected' }} @endif>
                                        Untuk dikopi dan dipasang di Papan Pengumuman
                                    </option>
                                    <option value="Untuk dilengkapi Surat Tugas/SPPD/Dispensasi" @if (old('intruksi') == 'Untuk dilengkapi Surat Tugas/SPPD/Dispensasi') {{ 'selected' }} @endif>
                                        Untuk dilengkapi Surat Tugas/SPPD/Dispensasi
                                    </option>
                                    <option value="Disiapkan untuk bahan briefing" @if (old('intruksi') == 'Disiapkan untuk bahan briefing') {{ 'selected' }} @endif>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('catatan') is-invalid @enderror"
                                    name="catatan" id="catatan" placeholder="Catatan (opsional)" value="{{ old('catatan') }}">
                                @error('catatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
