                ...
                <form class="forms-sample" id="modal-form" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <input required type="date"
                            class="form-control @error('tanggal_terima') is-invalid @enderror" name="tanggal_terima"
                            id="tanggal_terima" placeholder="dd/mm/yyyy"
...
<script>
    $('#exportPDF').click(function() {
        ...
        window.location.href = '/suratmasuk/exportpdf/' + min + '/' + max
    })
    ...
    $('#exportExcel').click(function() {
        ...
        console.log(min);
        window.location.href = '/suratmasuk/exportexcel/' + min + '/' + max
    })
</script>
