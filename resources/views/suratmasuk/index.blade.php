                        ...
                        <tbody>
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="" class="btn-sm btn-info " id="pdf" data-bs-toggle="modal"
                                            data-bs-target="#pdfModal{{ $row->id }}"><i class="mdi mdi-file"></i></a>
                                    </td>
                                    <td>
                                        <a href="#" class="btn-sm btn-warning edit ms-1" data-bs-toggle="modal"
                                            data-bs-target="#editModal{{ $row->id }}"><i
                                                class="mdi mdi-pencil"></i></a>
                                        <a href="#" class="btn-sm btn-danger delete ms-1"
