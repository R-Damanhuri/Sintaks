(function ($) {
    ...
    $(function () {
        ...
        if ($("#traffic-year-chart").length) {
            Chart.defaults.global.legend.labels.usePointStyle = true;
            var ctx = document
                .getElementById("traffic-year-chart")
                .getContext("2d");
            ...
            var smData = document
                .getElementById("traffic-year-chart")
                .getAttribute("data-sm-th");
            var skData = document
                .getElementById("traffic-year-chart")
                .getAttribute("data-sk-th");
        ...
        if ($("#jenis-sm-chart").length) {
            var smJenisCount = document
                .getElementById("jenis-sm-chart")
                .getAttribute("data-sm-jns-count");
        ...
        if ($("#jenis-sk-chart").length) {
            var skJenisCount = document
                .getElementById("jenis-sk-chart")
                .getAttribute("data-sk-jns-count");
